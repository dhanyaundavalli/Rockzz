...
<body class="bodyStyle">
	...
	<div id="mainContent">
		...
		<div id="mainPictures" class="center">
			...
			<hr>
			<div id="header" class="mainHeader"><p>Undavalli caf&eacute; Employee List!</p></div>
			<br>

		<?php
		$connection_string = "host=dhanyadbinstace.cluster-cpuog002uq5v.us-east-1.rds.amazonaws.com port=5432 dbname=postgres user=postgres password=Dhanya1508";
